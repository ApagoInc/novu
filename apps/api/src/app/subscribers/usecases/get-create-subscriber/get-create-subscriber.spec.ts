...
import { GetCreateSubscriber } from './get-create-subscriber.usecase';
...
describe('Get Subscriber', function () {
  let useCase: GetCreateSubscriber;
  ...
  beforeEach(async () => {
    ...
    useCase = moduleRef.get<GetCreateSubscriber>(GetCreateSubscriber);
  });
